...
class Lavoratore(models.Model):
    ...
    citta = models.CharField('Città', max_length=50, blank=True, null=True)
    ...
    scadenza_ap = models.IntegerField('Badge AdSP scadenza', blank=True, null=True)
    consegnato_ap = models.BooleanField('Badge AdSP consegnato', blank=True, null=True)
...
class Formazione(models.Model):
    ...
    mmc = models.DateField(blank=True, null=True, default=None)
    ...
    mmc_dc = models.DateField(blank=True, null=True, default=None)
    ...
    mmc_ck = models.CharField(max_length=20, choices=STATO_DOCUMENTI, blank=True, null=True, default='ok_np')
...
class Idoneita(models.Model):
    ...
    rumore50 = models.BooleanField('Esposizione giornaliera rumore < 50%', default=False)
    ...
    temperature = models.BooleanField('Temperature elevate', default=False)
    sbalzi_termici = models.BooleanField(default=False)
    scale = models.BooleanField(default=False)
    calzature_plantare = models.BooleanField(default=False)
    calzature_plantare_morbido = models.BooleanField(default=False)
    calzature_leggere = models.BooleanField(default=False)

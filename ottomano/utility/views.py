...
def documenti_controllati2(request):
    documenti_personale = documenti_controllati_util.get_documenti_personale()
    documenti_mezzi = documenti_controllati_util.get_documenti_mezzi()
    documenti_attrezzi = documenti_controllati_util.get_documenti_attrezzi()

    context = {
        'titolo': 'Controlla Documenti',
        'sezione_utility_attiva': 'active',
        'pagina_attiva_controlla_documenti': 'active',
        'documenti_personale_non_trovati': documenti_controllati_util.verifica_documenti(documenti_personale),
        'documenti_mezzi_non_trovati': documenti_controllati_util.verifica_documenti(documenti_mezzi),
        'documenti_attrezzature_non_trovate': documenti_controllati_util.verifica_documenti(documenti_attrezzi),
    }
